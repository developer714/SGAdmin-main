...
import { Button, TextField as MuiTextField, Grid, Checkbox, Typography, FormControlLabel } from "@mui/material";
import { spacing } from "@mui/system";

import useAuth from "../../../hooks/useAuth";
import { Alert, Divider } from "../application/common/styled";
    ...
    >
      {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
        <form noValidate onSubmit={handleSubmit}>
          ...
          <Grid item xs={12}>
            <FormControlLabel
              control={<Checkbox name="acceptTerms" checked={values.acceptTerms} color="primary" />}
              label="Accept Terms"

        ...
        <Box sx={{ width: isMD ? "640px" : "90vw" }}>
            ...
            <Grid item xs={12} borderBottom={"solid 1px #ccc"}>
              <Grid container pt={2} pb={2}>
                <Grid item sx={{ margin: "auto" }}>
                  <Typography variant="h2">Generate Origin SSL Certificate {"(Free)"}</Typography>
                </Grid>
                <Grid item xs></Grid>
          ...
          <Grid container pt={4}>
            ...
            >
              ...
              <Typography pt={2}>Are you sure you want to regenerate origin certificates?</Typography>
            </Grid>

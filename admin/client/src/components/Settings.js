...
import { Box, Button, Drawer, Fab as MuiFab, Grid, ListItemButton, Typography } from "@mui/material";
...
const DemoButton = styled.div`
  ...
  font-size: 0.825rem;
  position: relative;
  border: 1px solid ${(props) => (!props.active ? props.theme.palette.action.selected : props.theme.palette.action.active)};
`;
...
function Demos() {
  return (
    <Wrapper>
      ...
      <Box my={3} mx={4}>
        <Button component={Link} to="/documentation/welcome" variant="outlined" size="large" target="_blank" fullWidth={true}>
          Documentation
        </Button>
      </Box>
      <Box my={3} mx={4}>

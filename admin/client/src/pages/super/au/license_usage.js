...
import OrganisationList from "../../../components/pages/application/auth/T_Organisation";
...
function SAOrganisation() {
  const { setErr, errMsg, getLicenseStatus4Orgs, rows_per_page } = useAU();
  ...
  return (
    <React.Fragment>
      <Helmet title="SA AU License Status" />
      <Grid container sx={{ display: "flex", alignItems: "center" }}>
        <Grid item>
          <Typography variant="h3" gutterBottom display="inline">
            Auth Management License Status
          </Typography>
        </Grid>
        <Grid item xs></Grid>

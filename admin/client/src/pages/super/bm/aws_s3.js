...
import AwsS3CfgHistoryList from "../../../components/pages/application/bot/T_AwsS3CfgHistory";

import { Button, CollapseAlert, Divider, LoadingButton, SnackbarAlert } from "../../../components/pages/application/common/styled";
import { UserRole } from "../../../utils/constants";

function SAAwsS3Cfgs() {
  const { awsS3Cfgs, getAwsS3CfgHistory, insertAwsS3Cfg, applyAwsS3Cfg, errMsg, setErr } = useBM();

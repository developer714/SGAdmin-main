...
function EditCustomRuleModal({ open, handleClose, ruleID }) {
  // const theme = useTheme();
  // const isMD = useMediaQuery(theme.breakpoints.up("md"));

  const { curCustomRule, getCustomRule, createCustomRule, updateCustomRule } = useRule();

  React.useEffect(() => {
    if (open && ruleID) getCustomRule(ruleID);
...
export default EditCustomRuleModal;

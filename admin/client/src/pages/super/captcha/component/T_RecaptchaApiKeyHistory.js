...
function EnhancedTable() {
  const { reCaptchaApiKeys, reCaptchaApiKeyTotal, reCaptchaApiKeyFrom, reCaptchaApiKeySize, getHcaptchaSecretKeyHistory } = useCaptcha();
  var totalCount = reCaptchaApiKeyTotal;
  ...
  React.useEffect(() => {
    setPage(reCaptchaApiKeyFrom / reCaptchaApiKeySize);
  }, [reCaptchaApiKeyFrom, reCaptchaApiKeySize]);
  React.useEffect(() => {
    setRowsPerPage(reCaptchaApiKeySize);
  }, [reCaptchaApiKeySize]);
        ...
        <TableContainer>
          <Table aria-labelledby="tableTitle" size={"medium"} aria-label="enhanced table">
            ...
            {reCaptchaApiKeys === null ? (
              ...
              <TableBody>
                {stableSort(reCaptchaApiKeys, getComparator(order, orderBy)).map((row, index) => {
                  return (
                    <TableRow>
                      <TableCell
                        align="left"
...
function RecaptchaApiKeyHistoryList() {
  return <EnhancedTable />;
}
export default RecaptchaApiKeyHistoryList;
